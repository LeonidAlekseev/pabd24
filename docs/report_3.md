...
Test [io_bounded](../log/io_bounded_dev.txt)
- Среднее время обработки запроса = 1.129 сек.

Test [cpu_bounded](../log/cpu_bounded_dev.txt)
- Среднее время обработки запроса = 1.084 сек.
- Критическое значение n = 1 000 000

Test [cpu_multithread](../log/cpu_multithread_dev.txt)
- Среднее время обработки запроса = 0.212 сек.
- Критическое значение n = 1 000 000
...
Test [predict_io_bounded](../log/io_bounded_prod.txt)
- Среднее время обработки запроса = 5.666 сек.

Test [predict_cpu_bounded](../log/cpu_bounded_prod.txt)
- Среднее время обработки запроса = 0.657 сек.
- Критическое значение n = 1 000 000

Test [predict_cpu_multithread](../log/cpu_multithread_prod.txt)
- Среднее время обработки запроса = 0.136 сек.
- Критическое значение n = 1 000 000
